...
namespace JWTWebToken.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // maintaining the state of the user - JWT Token Authentication is chosen
            ...
            .AddJwtBearer(jwtBearerOptions =>
            {
                ...
                jwtBearerOptions.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    IssuerSigningKey = new SymmetricSecurityKey(Encoding.ASCII.GetBytes(Configuration["JWTSettings:GeheimeSleutel"])),
